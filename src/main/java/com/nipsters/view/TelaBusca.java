...
public class TelaBusca extends JPanel {
	...
	public TelaBusca() {
		...
		TabelaAtestado.setModel(new DefaultTableModel(
			new Object[][] {
				{"1Informações","Do","Atestado","Pesquisado"},
				{"2Informações","Do","Atestado","Pesquisado"},
				{"3Informações","Do","Atestado","Pesquisado"},
				{"4Informações","Do","Atestado","Pesquisado"},
				{"5Informações","Do","Atestado","Pesquisado"},
				{"6Informações","Do","Atestado","Pesquisado"},
			},
			new String[] {
				"N\u00FAmero", "Data", "Tipo de atestado"
			}
		) {
			private static final long serialVersionUID = 1L;
		...
		TabelaNome.setModel(new DefaultTableModel(
			new Object[][] {
